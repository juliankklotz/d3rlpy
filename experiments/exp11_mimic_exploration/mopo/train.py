...
def train(args=get_args()):
    ...
    dataset = dataset#d4rl.qlearning_dataset(env)
    args.obs_shape = obs_shape#env.observation_space.shape
    args.action_dim = action_dim#np.prod(env.action_space.shape)
    ...
    if args.auto_alpha:
        target_entropy = args.target_entropy if args.target_entropy \
            else -np.prod(1)#TODO env.action_space.shape)
    ...
    dynamics_model = TransitionModel(obs_space=1#TODO,
                                     action_space=1#TODO,
