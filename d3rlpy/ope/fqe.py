...
from ..algos.transformer import TransformerAlgoBase, TransformerAlgoImplBase
...
class _FQEBase(QLearningAlgoBase[FQEBaseImpl, FQEConfig]):
    _algo: QLearningAlgoBase[QLearningAlgoImplBase, LearnableConfig] | TransformerAlgoBase[TransformerAlgoImplBase,LearnableConfig]
    _config: FQEConfig
    _impl: Optional[FQEBaseImpl]

    def __init__(
        self,
        algo: QLearningAlgoBase[QLearningAlgoImplBase, LearnableConfig] | TransformerAlgoBase[TransformerAlgoImplBase,LearnableConfig],
        config: FQEConfig,
    ...
    @property
    def algo(self) -> QLearningAlgoBase[QLearningAlgoImplBase, LearnableConfig] | TransformerAlgoBase[TransformerAlgoImplBase,LearnableConfig]:
        return self._algo
...
class _FQEBaseTrajectory(QLearningAlgoBase[FQETrajectoryBaseImpl, FQEConfig]):
    _algo: QLearningAlgoBase[QLearningAlgoImplBase, LearnableConfig] | TransformerAlgoBase[TransformerAlgoImplBase,LearnableConfig]
    _config: FQEConfig
    _impl: Optional[FQEBaseImpl]
...
class FQETrajectory(_FQEBaseTrajectory):
    r"""Fitted Q Evaluation.
